...
build-webapp-source -builddirectory $buildfullpath -repo $($repobaseurl+"Portal") -appname "Portal" -branchname "origin/main" -OSType $OSType
build-webapp-source -builddirectory $buildfullpath -repo $($repobaseurl+"PortalAccess") -appname "PortalAccess" -branchname "origin/main" -OSType $OSType


$extrafiles= get-extrafiles -filepath $($projectpath+"/infrastructure/tools/buildextrafiles.csv")
set-init-sources -projectpath $projectpath -extrafiles $extrafiles -builddirectory $buildrelativepath -OSType $OSType -branchname "origin/main" #"origin/main" #"identiyupgrades"
